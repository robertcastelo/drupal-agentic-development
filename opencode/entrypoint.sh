...
# --- 2.5. OpenChamber workspace path ---
# The project is bind-mounted at /home/openchamber/workspaces/sandbox in
# docker-compose.opencode.yaml, so OpenChamber's file paths resolve directly.
